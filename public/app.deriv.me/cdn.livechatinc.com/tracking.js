!(function () {
    ...
    function z(e, t) {
        ...
        for (let o = 0; i.length > o; o++) if (!n(i[o], t) || !P(e[i[o]], t[i[o]])) return !1;
        return !0;
    }
        ...
        Y = e => {
            const t = (function (e) {
                ...
                e
                    .split('&')
                    .filter(Boolean)
                    .map(e => e.split('=').map(e => decodeURIComponent(e.replace('+', '%20'))))
            ...
            function (t) {
                return function (n, i) {
                    if (0 === n) {
                        ...
                        t(0, function (t, n) {
                            0 === t && (r = n),
                                1 === t ? (a && e(o, n) ? r(1) : ((a = !0), (o = n), i(1, n))) : i(t, n);
                        });
                    }
                };
            }
                        ...
                        e(0, (e, t) =>
                            0 === e
                                ...
                                : 1 === e
                                  ...
                                  : void (2 === e && ((r = null), t && ((s = t), o(2), a && i(e, t))))
                        ),
                        (a = !0),
                        i(0, (e, t) => {
                ...
                return function () {
                    return (
                        (function (e, t, n) {
                            ...
                            return !0;
                        })(t, i, arguments) || (o = e.apply(null, arguments)),
                        (i = arguments),
                        o
                    );
                };
        ...
        return function (e) {
            ...
            'function' == typeof n
                ? (console.warn(
                  ...
                  (o = new i()),
                  (r = n))
                : ((o = n.cacheObject || new i()), (r = n.selectorCreator || Ne.createSelector));
            var a = function () {
    ...
    const We = (e, t) => t,
        ...
        He = je([(e, t) => qe(e, t).events.orderedIds, (e, t) => qe(e, t).events.byIds], (e, t) => e.map(e => t[e]))(
            We
        ),
        Ve = je([qe, He], (e, t) =>
            T({}, e, {
    ...
    Ne.createSelector([He, e => Ge(e).id], (e, t) => {
        return (function (e, t, n) {
            ...
            e =>
                (e.author === t && 'message' === e.type && !(e.properties && 'file' === e.properties.serverType)) ||
                (!0 === e.seen && !Je[e.type] && !!e.serverId),
            (n = e).length - 1,
            n
        );
        var n;
    ...
    const Ze = () => !!document.documentElement.currentStyle,
        Qe = (e, t) => {
            ...
            if (Ze() && o && n('width', r) && null !== r.width) {
                r.width =
                    S([r.width, i.paddingLeft, i.paddingRight, i.borderLeftWidth, i.borderRightWidth].map(parseFloat)) +
                    'px';
            }
            if (Ze() && o && n('height', r) && null !== r.height) {
                r.height =
                    S(
                        [r.height, i.paddingTop, i.paddingBottom, i.borderTopWidth, i.borderBottomWidth].map(parseFloat)
                    ) + 'px';
            }
            return r;
        };
    ...
    const Pt = () =>
            'function' == typeof window.webkitAudioContext || 'function' == typeof window.AudioContext
                ? (() => {
                      const e = xt(),
                          t = I(t => {
                              const n = e.preload(t);
    ...
    const St = () => {
        ...
        Dt = () =>
            _(navigator.platform, ['iPad Simulator', 'iPhone Simulator', 'iPod Simulator', 'iPad', 'iPhone', 'iPod']) &&
    ...
    const cn = ['buttons', 'allowed_domains', 'prechat_form', 'ticket_form', '__priv', 'properties'],
        ...
        gn = function (e, t) {
            ...
            return sn(fn('get_dynamic_configuration', e), {
                ...
                if (
                    ((19196658 !== e.licenseId && '4c8c0751-837f-4a11-928e-047b2d095307' !== e.organizationId) ||
        ...
        _n = (e, t) => e,
        wn = e => {
            const { buttons: t, allowed_domains: n, prechat_form: i, ticket_form: o, __priv: r, properties: a } = e,
                s = qt(e, cn),
                c = r.group,
                l = _n('boolean' == typeof r.enable_textapp ? r.enable_textapp : void 0),
                d = _n(vn(c['chat_window.new_theme.name'], ['smooth', 'modern'])),
                u = _n(vn(c['chat_window.new_theme.variant'], ['light', 'dark'])),
                m = c['chat_window.new_theme.background_color'],
                p = _n(vn(c['chat_window.theme.minimized'], ['circle', 'bar'])),
                f = _n('1' === c['chat_window.display_avatar']),
                g = _n('0' === c['chat_window.disable_sounds']),
                h = _n('1' === c['rate_me.enabled']),
                v = _n('1' === c['chat_window.display_transcript_button']),
                _ = _n('1' === c['chat_window.display_logo']),
                w = _n(c['chat_window.logo_path']),
                y = _n(c.language),
                b = _n(vn(c['chat_window.screen_position'], ['right', 'left'])),
                k = _n(parseInt(c['chat_window.offset_x'])),
                x = _n(parseInt(c['chat_window.offset_y'])),
                C = '0' === r.group.tickets_enabled,
                E = !!!r.disable_native_tickets && !!o,
                I = hn(e),
                A = C || I || E;
            return T(
                {},
                    ...
                    __unsafeProperties: T(
                            ...
                            : {},
                        {
                            group: {
                                ...
                                ratingEnabled: h,
                                screenPosition: b,
                                screenPositionOnMobile: vn(r.group['chat_window.mobile_screen_position'], [
                                    'right',
                                    'left',
                                ]),
                                ...
                                theme: {
                                    ...
                                    visitorMessageColorBackground:
                                        r.group['chat_window.new_theme.visitor_message_color_background'],
                            ...
                            ticketFormMode:
                                ...
                                hn(L)
                                    ? 'helpdesk'
                                    : '0' === L.__priv.group.tickets_enabled
                                      ? 'offline_message'
                                      : 'livechat'),
                        }
                    ),
            ...
            return Qt(
                () =>
                    sn(r, {
                        ...
                        let { staticConfig: n, localization: i } = t;
                        return T({}, qt(t, ln), wn(n), {
    ...
    function Tn(e, t, n, i) {
        ...
        Nt()
            ? ((r.documentElement.lang = a), (r.head.innerHTML = e), (r.body.innerHTML = t))
            : (r.open(),
              r.write(
                  '\n\t\t\t<!DOCTYPE html>\n\t\t\t<html lang="' +
                      a +
                ...
                for (const n of t.split(';')) {
                    ...
                    t &&
                        ...
                        e.addEventListener(t, n => {
                            ...
                            if ('click' === t && 'copy' === e.getAttribute(En))
                                return (
                                    (h = e.getAttribute(In)),
                                    navigator.clipboard ? navigator.clipboard.writeText(h).catch(bn) : bn(h),
    ...
    const Pn = e => {
            ...
            if ((t && !jt() && r.push('autoplay;'), o && r.push('display-capture *;'), n)) {
                ...
                r = [].concat(
                    r,
                    ['microphone *;', 'camera *;'],
                    Object.keys(((s = Boolean), a((c = e)).reduce((e, t) => (s(c[t]) && (e[t] = c[t]), e), {})))
                );
            }
            var s, c;
    ...
    let Dn = null;
    const Fn = () => {
            if (Dn) throw Error('Title notification service already initialized');
            Dn = (() => {
                try {
                    let e,
                        t = document.title,
        ...
        Nn = () => {
            if (!Dn) throw Error('Title notification service not initialized');
            return Dn;
        },
        Bn = e => {
            var t, n;
            const i = ['http:', 'https:'];
            return !i.includes(null != (t = se(e)) ? t : '') && i.includes(null != (n = se(document.referrer)) ? n : '')
                ? document.referrer
                : e;
        },
        jn = () => ({
            title: Dn ? Dn.getOriginalPageTitle() : document.title,
    ...
    var qn = 'application/x-postmate-v1+json',
        Hn = 0,
        Vn = {
            handshake: 1,
            'handshake-reply': 1,
                        ...
                        var i = ++Hn,
                            o = function (e) {
                                e.data.uid === i &&
                                    ...
                                    (t.parent.removeEventListener('message', o, !1), n(e.data.value));
                            };
                        t.parent.addEventListener('message', o, !1),
                            t.child.postMessage(
                                {
                                    postmate: 'request',
                                    type: qn,
            ...
            return (
                (e.prototype.sendHandshake = function (t) {
                    ...
                    return new e.Promise(function (e, a) {
                        ...
                        i.frame.attachEvent ? i.frame.attachEvent('onload', l) : i.frame.addEventListener('load', l),
                            (i.frame.src = t);
                    });
                }),
                e
    ...
    function ri(e) {
        return ye(
            ti(e, e => Ve(e, oi).active),
            ze(1),
            xe(t =>
                t
                    ? ye(
                          ti(e, e => Ve(e, oi).properties.currentAgent),
                          ge(Boolean),
                          ke(() => t),
                          Oe(1)
                      )
    ...
    var vi = (e, t) => {
        ...
        ye(
            ...
            ['prechat', 'postchat', 'ticket', 'offline'].forEach(t => {
                var n;
                ye(
                    _e(we(e, 'set_default_view'), we(e, 'set_current_view')),
                    ge(e => e.viewInfo && 'Chat' === e.viewInfo.view && e.viewInfo.default === t),
                    De(we(e, 'unbind')),
                    ((n = () => {
                        const [n, i] = {
                                    ...
                                    if (0 === t) {
                                        ...
                                        e(0, function (e, t) {
                                            if (
                                                ...
                                                return c
                                                    ? void n(1, t)
                                                    : (i.push(t), i.length > s && i.shift(), void r(1));
                                            n(e, t);
                                        });
                                    }
                                };
                        ...
                        return function (t, i) {
                            if (0 === t) {
                                var o,
                                    ...
                                    a = function (e, t) {
                                        if (0 !== e)
                                            return 1 === e ? (i(1, t), void r(1)) : void (2 === e && (r = null));
                                        (r = t)(1);
                                    },
                                    s = function (e, t) {
    ...
    const _i = e => {
        ...
        bi = function (e) {
            ...
            return t
                ? ((n = e),
                  ...
                  })).then(e => (e ? t.waitForIdle(5e3).then(() => (t.disconnect(), t.getLongTasks())) : null))
        ...
        Ei = () => {
            ...
            const e = bi().then(e =>
                e ? S(e.filter(e => _('.livechatinc.com', e.attribution[0].containerSrc)).map(e => e.duration)) : null
            );
            return {
                getLogs: () =>
                    e.then(e => {
                        const t = (() => {
                                const e = performance
                                    ...
                                    .filter(e => /livechatinc\.com\/(.+\/)?tracking.js/.test(e.name));
    ...
    const Li = ['America/', 'Europe/'],
        ...
        Di = (e, t, n) => {
            ...
            (i.id = 'loader'),
                (i.style.border =
                    '4px solid ' + ('light' === n.theme.variant ? 'rgba(0, 0, 0, 0.1)' : 'rgba(255, 255, 255, 0.1)')),
        ...
        Fi = (e, t) => {
            ...
            const s = new BroadcastChannel(
                    e.organizationId +
                        (e.uniqueGroups && 'number' == typeof e.group ? ':' + e.group : '') +
                ...
                c = d(300, async function () {
                    ...
                    window.documentPictureInPicture
                        ...
                        .then(e => {
                            ...
                            const { config: s, rtl: c } = Xe(t.state);
                            (e.document.body.style.backgroundColor = Kt[s.theme.variant].widgetBackground),
                                (e.document.body.style.color = Kt[s.theme.variant].primaryTextColor),
                                ...
                                i ||
                                    ((e, t, n, i, o, r) => {
                                        ...
                                        (d.textContent = i('cancel')),
                                            (d.style.backgroundColor = Kt[o.theme.variant].secondaryButtonBackground),
                                            (d.style.color = Kt[o.theme.variant].primaryTextColor),
                                            a.append(s, c, l, d),
        ...
        Ni = (e, t) => {
            ...
            if ('onbeforeprint' in window)
                window.addEventListener('beforeprint', n), window.addEventListener('afterprint', i);
    ...
    var Bi = (e, t, n) => {
            ...
            let o, r;
            const a = e => {
                    const { visibility: t, eyeCatcher: n, availability: i, readyState: o } = Xe(e);
                    return n.hidden || 'minimized' !== t.state || 'online' !== i || o === F;
                },
                s = () => {
    ...
    const Wi = Ft(),
        qi = (e, t) => {
            ...
            return (
                !t.region || ('fra' !== t.region && 'eu-west3' !== t.region) || (n = n.replace('secure', 'secure-fra')),
            ...
            return {
                ...
                hidden:
                    ...
                    ((e => {
                        ...
                        return Wi && t.hasCustomMobileSettings ? t.initiallyHiddenOnMobile : t.initiallyHidden;
                    })(n) ||
    ...
    const Yi = 'liveChatChatId',
        ...
        Xi = (e, t) => {
            const n = ((e, t, n) => i => {
                ...
                if (!_(s, t.allowedActions))
                    return void console.error(
                        t.widgetName +
                            ': Action "' +
                            s +
                            '" is not allowed. Allowed actions: ' +
                            t.allowedActions.join(', ')
                    );
                const c = ((e, t, n) => {
                    const i = {},
                        o = n.allowedParams[t];
                ...
                ((e, t, n, i) => {
                    ...
                    if ('maximize' === t) {
                        const t = {};
                        return (
                            n.messageDraft && (t.messageDraft = n.messageDraft),
                            'livechat' === i && n.startChat && (t.startChat = 'true' === n.startChat),
                            'openwidget' === i && n.feature && (t.feature = n.feature),
                            void e.maximize(t)
                        );
                    }
            ...
            ye(
                ti(e, e => e.application.readyState),
                ge(e => e === N),
                Oe(1),
                he(() => {
    ...
    var Ki = (e, t) => {
        ...
        return (
            !!n &&
            [].concat(e, ['livechatinc.com', 'lc.chat', 'text.my', 'text.at']).some(e => {
    ...
    function io(e, t, n) {
        return function (i) {
            var o, r, s;
            let { prettyPrint: c = !0 } = void 0 === i ? {} : i;
            const { trackerName: l } = t.analytics.googleAnalytics,
                d = !Ki(n.allowedDomains, document.location.href),
                u = [
                ...
                { desktopVisibility: p, mobileVisibility: f } = (e => {
                    let {
                            disabledMinimized: t,
    ...
    function so(e, t) {
        ...
        if (i) {
            const [e, t] = i;
            return void console.error(
                '[LiveChatWidget] Customer ' + e + ' cannot be set to ' + ('' === t ? 'empty string' : t)
            );
        }
    ...
    function po(e, t, n) {
        ...
        ye(
            ...
            he(() => mo(i.on_chat_window_opened))
        ),
            ye(
                ci(e, () =>
                    (function (e) {
                        return ye(
                            ti(e, e => Wt(e, 'minimized')),
                            ze(1),
                            ge(b)
                        );
                    })(e)
                ),
                he(() => mo(i.on_chat_window_minimized))
            ),
            ye(
                (function (e) {
                    return ye(
                ...
                he(() => mo(i.on_chat_window_hidden))
            ),
            ye(
                ii(e),
                he(e =>
                    mo(i.on_chat_state_changed, {
            ...
            ye(
                ci(e, () => ri(e)),
                ge(y),
                he(() => mo(i.on_chat_ended))
            ),
            ye(
                ci(e, () => we(e, 'on_message')),
                he(e => mo(i.on_message, e))
            ),
            ye(
                we(e, 'widget_resize'),
                he(e => {
            ...
            ro(e, i, 'on_postchat_survey_submitted'),
            ro(e, i, 'on_prechat_survey_submitted'),
            ro(e, i, 'on_rating_comment_submitted'),
            ro(e, i, 'on_rating_submitted'),
            ro(e, i, 'on_ticket_created'),
            (i.set_custom_variables = t => {
                Qi('LC_API.set_custom_variables', t), co(e, ao(t));
            }),
            (i.update_custom_variables = t => {
                Qi('LC_API.update_custom_variables', t),
                    so(e, {
                        properties: ao(t),
                    });
            }),
            (i.set_visitor_name = t => {
                Qi('LC_API.set_visitor_name', t),
                    so(e, {
                        name: lo(t),
                    });
            }),
            (i.set_visitor_email = t => {
                Qi('LC_API.set_visitor_email', t),
                    so(e, {
                        email: lo(t),
                    });
            }),
            ...
            (i.agents_are_available = () => (
                Qi('LC_API.agents_are_available'), 'online' === Xe(e.state, 'availability')
            )),
            (i.chat_window_maximized = () => (Qi('LC_API.chat_window_maximized'), Wt(e.state, 'maximized'))),
            (i.chat_window_minimized = () => (Qi('LC_API.chat_window_minimized'), Wt(e.state, 'minimized'))),
            (i.chat_window_hidden = () => (Qi('LC_API.chat_window_hidden'), Wt(e.state, 'hidden'))),
            (i.visitor_queued = () => (Qi('LC_API.visitor_queued'), Ve(e.state, uo).properties.queued)),
            (i.chat_running = () => (Qi('LC_API.chat_running'), Ve(e.state, uo).active)),
            (i.visitor_engaged = () => (
                Qi('LC_API.visitor_engaged'),
                i.visitor_queued() || i.chat_running() || !!Ve(e.state, uo).properties.fakeAgentMessageId
            )),
            (i.get_window_type = () => (Qi('LC_API.get_window_type'), 'embedded')),
            (i.close_chat = () => {
                Qi('LC_API.close_chat'),
                    e.call('storeMethod', [
                        'requestUpdateChat',
                        uo,
                        {
            ...
            (i.diagnose = io(e, t, n)),
            (i.get_last_visit_timestamp = () => Xe(e.state).clientLastVisitTimestamp),
            (i.get_visits_number = () => Xe(e.state).clientVisitNumber),
            (i.get_page_views_number = () => Xe(e.state).clientPageViewsCount),
            (i.get_chats_number = () => Xe(e.state).clientChatNumber),
            (i.get_visitor_id = () => Ge(e.state).serverId),
            (i.get_chat_id = () => Ve(e.state, uo).serverId),
    ...
    const fo = {
            ...
            navigate(e, t) {
                void 0 === t && (t = '_blank'),
                    Qn(() => {
                        window.location.origin === K(e) && 'function' == typeof this.handler
                            ? this.handler(ie(e))
                            : window.open(e, t);
                    });
            },
        ...
        ho = 'liveChatChatId',
        vo = e => {
            let { trackerId: t, orderId: n, orderPrice: i } = e;
            return (
                w(qt(e, go)) ||
                    console.warn(
    ...
    function bo(e, t, n) {
        ...
        function p(t, n, o) {
            switch (n) {
                ...
                case 'rich_message_button_clicked':
                    return void i[t](n, o);
                case 'ready':
                    return void (Xe(e.state, 'readyState') !== F
                        ? Qn(() =>
                              o({
                                  state: h('state'),
        ...
        function h(t) {
            switch (t) {
                case 'state': {
                    const { availability: t, visibility: n } = Xe(e.state);
                    return {
                        availability: t,
                        visibility: n.state,
                    };
                ...
                case 'chat_data': {
                    const { serverId: t, active: n, properties: i } = Ve(e.state, ho);
                    return {
                        chatId: t || null,
                ...
                case 'customer_data': {
                    const { serverId: t, name: n, email: i, properties: o } = Ge(e.state),
                        { isReturning: r } = Xe(e.state),
                        { active: a, properties: s, events: c } = Ve(e.state, ho),
                        { queued: l, fakeAgentMessageId: d } = s,
                        m = u(e => {
                            let { id: t } = e;
                            return t === d;
                        }, c);
        ...
        void 0 === (m = d.other) && (m = []),
            ...
            ye(
                ci(e, () => ni(e, () => h('customer_data').status)),
                he(e =>
                    a('customer_status_changed', {
                        status: e,
                    })
                )
            ),
            ye(
                ...
                ke(t => wo(e, t)),
                ge(b),
                he(e => a('greeting_hidden', _o(e)))
            ),
            ye(
                ci(e, () => li(e, 'displayedIds')),
                ke(t => wo(e, t)),
                ge(b),
                he(e => a('greeting_displayed', _o(e)))
            ),
            ye(
                we(e, 'on_rating_submitted'),
                he(e => a('rating_submitted', e))
            ),
            ye(
                _e(we(e, 'add_event'), we(e, 'send_event')),
                ge(e => {
                    let { event: t } = e;
            ...
            ye(
                _e(
                    ...
                    ye(
                        we(e, 'rich_greeting_button_clicked'),
                        ke(e => {
                ...
                he(e => a('rich_message_button_clicked', e))
            ),
            ye(
                _e(
                    ye(
                        we(e, 'on_ticket_created'),
                        ke(() => 'ticket')
                    ),
                    ye(
                        we(e, 'on_prechat_survey_submitted'),
                        ke(() => 'prechat')
                    ),
                    ye(
                        we(e, 'on_postchat_survey_submitted'),
                        ke(() => 'postchat')
                    )
                ),
                he(e =>
            ...
            ye(
                ...
                ge(e => {
                    ...
                    return (
                        ...
                        -1 !== t.properties.customId.indexOf('cyber-finger-snapshot-request-')
                    );
                }),
                he(t => {
                    let { event: n } = t;
    ...
    const Po = D ? 0 : 300,
        ...
        Oo = e => {
            const { mobile: t } = Xe(e.state);
            let n = !1,
                i = null,
                o = null,
                r = null;
            const a = e => {
                    const { messageDraft: t, initialMessageDraft: n } = Xe(e.state);
                    return !t && !n;
                },
                s = t => {
                    var n;
            ...
            const m = ye(
                    _e(
                        ye(
                            ve(document, t ? 'touchstart' : 'mousedown'),
                            ke(e => ({
                                type: 'start',
                                event: e,
                            }))
                        ...
                        ye(
                            ve(document, t ? 'touchend' : 'mouseup'),
                            ke(e => ({
                                type: 'end',
                                event: e,
                            }))
                ...
                p = ye(ve(document, 'click'), De(we(e, 'unbind')));
            ye(
                d,
                he(() => {
                    c();
                ...
                ye(
                    ...
                    he(() => {
                        ...
                        i && (clearTimeout(i), (i = null)),
                            ...
                            null != (t = Xe(e.state).websiteTextSelection) &&
                                t.text &&
                                s({
                                    text: '',
                                    state: 'hidden',
        ...
        Do = e => {
            ...
            const i =
                null == e || null == (t = e.__unsafeProperties) || null == (t = t.group) || null == (t = t.theme)
                    ? void 0
                    : t.name;
            let o = 'default';
            return (
                (null == e || null == (n = e.__unsafeProperties) ? void 0 : n.enableTextApp) || !1
                    ? (o = 'ta-default')
                    : 'modern' === i && (o = 'modern'),
                (e => {
                    switch (e) {
        ...
        Wo = (e, t, n, i, o, r, a, s) => {
            ...
            const p = {
                    ...
                    setLiveAnnouncerMessage(e) {
                        ...
                        i
                            ? (i.textContent = t)
                            : console.error('[LiveChat] Aria announcer element with level "' + n + '" not found');
                    },
                    renderCrossFrameMarkup(t) {
                        ...
                        o ||
                            ...
                            e.element.appendChild(Bo('polite')),
                            e.element.appendChild(Bo('assertive')),
                    ...
                    removeLightboxMarkup() {
                        ...
                        e &&
                            (this.handleLightboxKeydown &&
                                (e.contentDocument.removeEventListener('keydown', this.handleLightboxKeydown),
                                (this.handleLightboxKeydown = null)),
                            e.remove());
                    },
                    getMinimizedDimensions() {
                        if (!e.element.offsetWidth) return null;
                        const t = document.getElementById(ot).contentDocument.querySelector('[role="main"]');
                        return Qe(['width', 'height'], t);
                    },
                    callElementMethod(e) {
                        var t, n;
                        let [i, o, ...r] = e;
                        null == (t = document.getElementById(ot).contentDocument.querySelector(i)) ||
                            null == (n = t[o]) ||
            ...
            if ('openwidget' === a) {
                var v;
                h = !!(null == (v = n.features.find(e => 'forms' === e.name)) ||
                null == (v = v.properties) ||
                null == (v = v.templates)
                    ? void 0
                    : v.bugreport);
        ...
        qo = (e, t, n, i, o, r) => {
            e.call('storeMethod', ['setLocalization', i]),
                (e => {
                    ...
                    function i(t) {
                        (e.state.application.visibility.interactionModality === t && t === n) ||
                ...
                n.custom || Ni(n.element, () => Wt(e.state, 'hidden')),
                Mo || 'wix' === t.integrationName || Bi(e, o, i),
                No(e.frame),
                (function (e, t, n) {
                                                ...
                                                Ot.isBridgeActive &&
                                                    (Xe(e.state, 'muted') ||
                                                        (((e, t) =>
                                                            ...
                                                            e.author !== t &&
                                                            'custom' !== e.type)(i, Ye(e.state)) &&
                                                            t(yt)));
                                            }),
                                            e.on('reaction_received', n => {
                                                let { event: i } = n;
                                                Ot.isBridgeActive &&
                                                    (Xe(e.state, 'muted') || (Ye(e.state) === i.author && t(yt)));
                                            }));
                                    });
                                });
                            })(e),
                ...
                'wix' === t.integrationName
                    ...
                    : (Co(e), 'openwidget' === r && Wn(e), Xi(e, r)),
                ji(e),
                'livechat' === r &&
                    ('documentPictureInPicture' in window &&
                        (e => {
                            var t;
                            return !!(null == (t = e.properties.license.bb9e5b2f1ab480e4a715977b7b1b4279)
                                ? void 0
                    ...
                    (e => {
                        ye(
                            ti(e, e => Xe(e).showTextSelectionTracking),
                            ge(Boolean),
                            Oe(1),
                            he(() => {
                                Oo(e);
                    ...
                    (e => {
                        const { actingAsDirectLink: t, embedded: n, mobileWrapper: i } = Xe(e.state);
                        if (t || !n || i) return;
                        let o = null,
                            r = null;
                        const a = ye(
                            ve(document, 'visibilitychange'),
                            ge(() => 'maximized' === Xe(e.state).visibility.state),
                            ke(() => !document.hidden)
                        );
                        ye(
                            a,
                            ...
                            ye(
                                ...
                                ge(() => !!r && Ve(e.state, Yi).properties.ended),
                                Oe(1),
                                he(() => {
            ...
            t.actingAsDirectLink ||
                ...
                e.on('register_exit_intent_listener', () => {
                    const t = ((e, t) => {
                        ...
                        return (
                            window &&
                                (Ui && window.removeEventListener('mouseout', Ui),
                ...
                e.on('apply_exit_intent_shade', () => {
                    ((e, t) => {
                        ...
                        (n.id = Vi),
                            ...
                            Ri && window.removeEventListener('mouseover', Ri),
                            (Ri = () => Gi(t)),
                            window.addEventListener('mouseover', Ri);
                    })(Si(o, !1), e);
                }),
                ...
                n.custom ||
                    (function (e, t) {
                        ...
                        const i = new IntersectionObserver(t => {
                            const i = t[0];
                            if (!i) return;
                            const o = i.isIntersecting;
                            o && n && e.emit('container_became_visible'), (n = !o);
                        });
                        i.observe(t);
                        const o = () => {
                            e.off('unbind', o), i.disconnect();
                        };
                        e.on('unbind', o);
                    })(e, n.element);
        },
                    ...
                    ? Ho(g).catch(e => {
                          if ('DEFAULT_WIDGET_NOT_LIVECHAT' === e.code && 'openwidget' === e.defaultWidget)
                              return (
                                  ...
                                  (window.OpenWidget = T({}, window.LiveChatWidget)),
                                  yn(e.organizationId, u, null, d)
                              );
                          throw e;
                      })
                    : yn(a, u, f, d, g.url);
        Promise.all([h, 'wix' === u ? $n() : jn(), et()])
            .then(e => {
                let [o, r, a] = e;
                if (!Ki(o.allowedDomains, window.top === window ? window.location.hostname : document.referrer))
                ...
                const s = Ei(),
                    ...
                    g = {};
                let h = !1;
                const v = $i('on_before_load'),
                    _ = $i('on_after_load');
                v(e => {
                    (e.disable_sounds = A),
                        (e.mobile_is_detected = () => Mo),
                        (e.chat_running = () => !1),
                        (e.visitor_engaged = () => !1),
                        (e.agents_are_available = () => -1 !== o.onlineGroupIds.indexOf(o.groupId)),
                        (e.get_window_type = () => 'embedded'),
                        (e.hide_chat_window = _i(u) ? A : () => (h = !0)),
                        (e.set_visitor_name = e => (g.name = lo(e))),
                        (e.set_visitor_email = e => (g.email = lo(e))),
                        (e.set_custom_variables = e => (g.properties = e ? ao(e) : {})),
                        (e.update_custom_variables = e => {
                            e && (g.properties = T({}, g.properties, ao(e)));
                        });
                });
                const w = T(
                    {},
                    ...
                    Promise.all([
                        ...
                        'openwidget' === i
                            ...
                            : ((y = {
                              ...
                              }).then(e => x(e => e.toLowerCase(), e))),
                    ])
                        .then(e => {
                            let [t, n] = e;
                            return (
                                m.custom || No(m.element),
                                qo(t, w, m, n, o, i),
                                ye(
                                    ti(t, e => Xe(e, 'readyState')),
                                    ge(e => e === N),
                                    Oe(1),
                                    ke(() => t),
                                    Fe
    ...
    function Ro() {
        et().then(e => {
            ['https://cdn.livechatinc.com/widget/static/js/configurator.CYAonVDN.js'].forEach(t => {
                ((e, t) => {
        ...
        Yo = () => {
            ...
            const e = {
                ...
                customIdentityProviderInitializer:
                    'function' == typeof t.custom_identity_provider ? t.custom_identity_provider : null,
                iframeAddress: null,
                region: _(t.region, ((n = W), a(n).map(e => n[e]))) ? t.region + '' : null,
            };
            var t, n;
            e.actingAsDirectLink ||
            !(te(de, window.location.search) || (R('session') && window.sessionStorage.getItem(de)))
                ? Vo('livechat', e)
                : Ro();
        };
