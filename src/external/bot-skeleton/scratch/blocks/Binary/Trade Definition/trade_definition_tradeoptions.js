...
window.Blockly.Blocks.trade_definition_tradeoptions = {
    ...
    updateAmountLimits() {
        ...
        account_limits
            .getStakePayoutLimits(currency, landing_company_shortcode, this.selected_market)
            .then(limits => {
                ...
                // Fix destructuring error by checking if limits exists and has required properties
            ...
            .catch(error => {
                console.error('Error getting stake/payout limits:', error);
            });
    },
