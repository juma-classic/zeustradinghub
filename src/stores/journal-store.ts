...
export default class JournalStore {
    ...
    pushMessage(
        ...
        // Fix MobX strict mode violation by creating new array instead of mutating
        const newMessage = { date, time, message, message_type, className, unique_id, extra };
        this.unfiltered_messages = [newMessage, ...this.unfiltered_messages];
    }
