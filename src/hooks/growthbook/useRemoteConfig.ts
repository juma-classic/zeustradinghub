...
function useRemoteConfig(enabled = false) {
    ...
    // During Jest tests we avoid performing the remote fetch and hashing because
    // it creates background async work and depends on browser globals. Tests
    // should rely on the initial bundled config.
